...
const RegisterScreen = ({ userRegister, register }) => {
    ...
    return (
        ...
        <div className='w-full md:max-w-md my-6 mx-auto'>
            ...
            <form onSubmit={submitHandler}>
                ...
                <div className='text-gray-500 mt-4'>Have an Account! <Link to={redirect ? `/login?redirect=${redirect}` : '/login'} className='text-black'>Login</Link></div>
            </form>
        </div>
    )
}
